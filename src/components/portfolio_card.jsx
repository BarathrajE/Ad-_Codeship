export function Portfolio_card({
  ...
  return (
    <div className="test position-relative pt-5">
      <img src={image} className="port_image position-relative z-0" alt="" />
      <p className="card_title hover_effect  position-absolute font_size_24 font-weight-600 text-white">
        {card_title}
      </p>
